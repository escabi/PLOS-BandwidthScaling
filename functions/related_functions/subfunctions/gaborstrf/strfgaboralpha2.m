...
%                     beta(7): Best spectral modulation frequency (octaves)
...
%
% (C) Monty A. Escabi, October 2006 (Edit 5/21 MAE; Jenna / Monty 10/23)
%
function [STRFm]=strfgaboralpha2(beta,input)
...
%Spectrotemporal Receptive Field - needed in case optimization converges
%with beta(20)==0 (second component gain==0) (Jenna / Monty 10/23)
if beta(20)==0
    STRFm=SRF1'*TRF1;
else
